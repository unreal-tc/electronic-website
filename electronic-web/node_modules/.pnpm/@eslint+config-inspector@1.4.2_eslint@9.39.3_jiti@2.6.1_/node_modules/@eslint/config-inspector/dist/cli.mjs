...
function _tryPort(port, host) {
	return new Promise((resolve$4) => {
		...
		server.listen({
			...
			server.close(() => {
				resolve$4(isSafePort(port2) && port2);
			});
		});
	});
}
...
const convertWslPathToWindows = async (path$4) => {
	if (/^[a-z]+:\/\//i.test(path$4)) return path$4;
	try {
		const { stdout } = await execFile$1("wslpath", ["-aw", path$4], { encoding: "utf8" });
		return stdout.trim();
	} catch {
		return path$4;
	}
...
const normalize = function(path$4) {
	if (path$4.length === 0) return ".";
	path$4 = normalizeWindowsPath(path$4);
	const isUNCPath = path$4.match(_UNC_REGEX);
	const isPathAbsolute = isAbsolute$2(path$4);
	const trailingSeparator = path$4[path$4.length - 1] === "/";
	path$4 = normalizeString$2(path$4, !isPathAbsolute);
	if (path$4.length === 0) {
		if (isPathAbsolute) return "/";
		return trailingSeparator ? "./" : ".";
	}
	if (trailingSeparator) path$4 += "/";
	if (_DRIVE_LETTER_RE.test(path$4)) path$4 += "/";
	if (isUNCPath) {
		if (!isPathAbsolute) return `//./${path$4}`;
		return `//${path$4}`;
	}
	return isPathAbsolute && !isAbsolute$2(path$4) ? `/${path$4}` : path$4;
};
const join = function(...segments) {
	...
	for (const seg of segments) {
		if (!seg) continue;
		if (path$4.length > 0) {
			const pathTrailing = path$4[path$4.length - 1] === "/";
			const segLeading = seg[0] === "/";
			if (pathTrailing && segLeading) path$4 += seg.slice(1);
			else path$4 += pathTrailing || segLeading ? seg : `/${seg}`;
		} else path$4 += seg;
	}
	return normalize(path$4);
};
function cwd() {
...
const resolve = function(...arguments_) {
	...
	for (let index = arguments_.length - 1; index >= -1 && !resolvedAbsolute; index--) {
		const path$4 = index >= 0 ? arguments_[index] : cwd();
		if (!path$4 || path$4.length === 0) continue;
		resolvedPath = `${path$4}/${resolvedPath}`;
		resolvedAbsolute = isAbsolute$2(path$4);
	}
...
function normalizeString$2(path$4, allowAboveRoot) {
	let res = "";
	let lastSegmentLength = 0;
	let lastSlash = -1;
	let dots = 0;
	let char = null;
	for (let index = 0; index <= path$4.length; ++index) {
		if (index < path$4.length) char = path$4[index];
		else if (char === "/") break;
		else char = "/";
		if (char === "/") {
			if (lastSlash === index - 1 || dots === 1);
				...
				if (res.length > 0) res += `/${path$4.slice(lastSlash + 1, index)}`;
				else res = path$4.slice(lastSlash + 1, index);
...
var require_async$3 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/providers/async.js": ((exports) => {
	...
	var AsyncProvider = class {
		...
		read(root, callback) {
			...
			this.#reader.onError((error) => {
				callFailureCallback$2(callback, error);
			});
			this.#reader.onEntry((entry) => {
				entries.push(entry);
			});
			this.#reader.onEnd(() => {
				callSuccessCallback$2(callback, entries);
			});
	...
	function callSuccessCallback$2(callback, entries) {
...
var require_stream = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/providers/stream.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_sync$3 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/providers/sync.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_providers = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/providers/index.js": ((exports) => {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	__exportStar$1(require_async$3(), exports);
	__exportStar$1(require_stream(), exports);
	__exportStar$1(require_sync$3(), exports);
}) });

//#endregion
//#region node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/providers/async.js
var require_async$2 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/providers/async.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.read = read$4;
	function read$4(path$4, settings, callback) {
		settings.fs.lstat(path$4, (lstatError, lstat) => {
			if (lstatError !== null) {
				callFailureCallback$1(callback, lstatError);
				return;
			}
			if (!lstat.isSymbolicLink() || !settings.followSymbolicLink) {
				callSuccessCallback$1(callback, lstat);
				return;
			}
			settings.fs.stat(path$4, (statError, stat$2) => {
				if (statError !== null) {
					if (settings.throwErrorOnBrokenSymbolicLink) {
						callFailureCallback$1(callback, statError);
						return;
					}
					callSuccessCallback$1(callback, lstat);
					return;
				...
				callSuccessCallback$1(callback, stat$2);
			});
		});
	}
...
var require_sync$2 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/providers/sync.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.read = read$3;
	function read$3(path$4, settings) {
		const lstat = settings.fs.lstatSync(path$4);
		if (!lstat.isSymbolicLink() || !settings.followSymbolicLink) return lstat;
		try {
			const stat$2 = settings.fs.statSync(path$4);
			if (settings.markSymbolicLink) stat$2.isSymbolicLink = () => true;
			return stat$2;
		} catch (error) {
...
var require_fs$3 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/adapters/fs.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.FILE_SYSTEM_ADAPTER = void 0;
	exports.createFileSystemAdapter = createFileSystemAdapter$1;
	const fs$7 = __require("node:fs");
...
var require_settings$2 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/settings.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var Settings$2 = class {
		...
		constructor(options = {}) {
			...
			this.fs = fs$6.createFileSystemAdapter(options.fs);
...
var require_stat = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/stat.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.stat = stat$1;
	exports.statSync = statSync$1;
	const async$1 = require_async$2();
	const sync$1 = require_sync$2();
	const settings_1$5 = require_settings$2();
	function stat$1(path$4, optionsOrSettingsOrCallback, callback) {
		if (typeof optionsOrSettingsOrCallback === "function") {
			async$1.read(path$4, getSettings$2(), optionsOrSettingsOrCallback);
			return;
		}
		async$1.read(path$4, getSettings$2(optionsOrSettingsOrCallback), callback);
	}
	function statSync$1(path$4, optionsOrSettings) {
		const settings = getSettings$2(optionsOrSettings);
		return sync$1.read(path$4, settings);
	}
	function getSettings$2(settingsOrOptions = {}) {
		if (settingsOrOptions instanceof settings_1$5.Settings) return settingsOrOptions;
		return new settings_1$5.Settings(settingsOrOptions);
	}
}) });

//#endregion
//#region node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/index.js
var require_out$2 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.stat@4.0.0/node_modules/@nodelib/fs.stat/out/index.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var settings_1$4 = require_settings$2();
	Object.defineProperty(exports, "Settings", {
		enumerable: true,
		get: function() {
			return settings_1$4.Settings;
		}
	});
}) });
...
var require_fs$2 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/adapters/fs.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.FILE_SYSTEM_ADAPTER = void 0;
...
var require_settings$1 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/settings.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Settings = void 0;
	const path$3 = __require("node:path");
	const fsStat$2 = require_out$2();
	...
	var Settings$1 = class {
		...
		constructor(options = {}) {
			...
			this.fs = fs$4.createFileSystemAdapter(options.fs);
			this.pathSegmentSeparator = options.pathSegmentSeparator ?? path$3.sep;
			this.stats = options.stats ?? false;
			this.throwErrorOnBrokenSymbolicLink = options.throwErrorOnBrokenSymbolicLink ?? true;
			this.fsStatSettings = new fsStat$2.Settings({
...
var require_fs$1 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/utils/fs.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var DirentFromStats = class extends fs$3.Dirent {
		[kStats];
	...
	for (const key of Reflect.ownKeys(fs$3.Dirent.prototype)) {
		const name = key;
		const descriptor = Object.getOwnPropertyDescriptor(fs$3.Dirent.prototype, name);
...
var require_utils = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/utils/index.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.fs = void 0;
...
var require_common$2 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/providers/common.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async$1 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/providers/async.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.read = read$2;
	const fsStat$1 = require_out$2();
	const rpl = require_run_parallel();
	const utils$1 = require_utils();
	const common$6 = require_common$2();
	...
	*/
	function makeRplTask(directory, entry, settings) {
		...
		return (done) => {
			action((error, stats) => {
				...
				if (settings.followSymbolicLinks) entry.dirent = utils$1.fs.createDirentFromStats(entry.name, stats, directory);
				done(null, entry);
			});
		};
	}
	function getStatsAction(entry, settings) {
		if (settings.stats) return (callback) => {
			fsStat$1.stat(entry.path, settings.fsStatSettings, callback);
		};
...
var require_sync$1 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/providers/sync.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.read = read$1;
	const fsStat = require_out$2();
	const utils = require_utils();
	const common$5 = require_common$2();
...
var require_scandir = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/scandir.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.scandir = scandir;
	exports.scandirSync = scandirSync;
	const settings_1$3 = require_settings$1();
	const async = require_async$1();
	const sync = require_sync$1();
	function scandir(path$4, optionsOrSettingsOrCallback, callback) {
		if (typeof optionsOrSettingsOrCallback === "function") {
			async.read(path$4, getSettings$1(), optionsOrSettingsOrCallback);
			return;
		}
		async.read(path$4, getSettings$1(optionsOrSettingsOrCallback), callback);
	}
	function scandirSync(path$4, optionsOrSettings) {
		const settings = getSettings$1(optionsOrSettings);
		return sync.read(path$4, settings);
	}
	function getSettings$1(settingsOrOptions = {}) {
		if (settingsOrOptions instanceof settings_1$3.Settings) return settingsOrOptions;
		return new settings_1$3.Settings(settingsOrOptions);
	}
}) });

//#endregion
//#region node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/index.js
var require_out$1 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.scandir@4.0.1/node_modules/@nodelib/fs.scandir/out/index.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var settings_1$2 = require_settings$1();
	Object.defineProperty(exports, "Settings", {
		enumerable: true,
		get: function() {
			return settings_1$2.Settings;
		}
	});
}) });
...
var require_settings = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/settings.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.Settings = void 0;
	const path$2 = __require("node:path");
	const fsScandir$1 = require_out$1();
	var Settings = class {
		basePath;
		concurrency;
		deepFilter;
		...
		constructor(options = {}) {
			...
			this.fsScandirSettings = new fsScandir$1.Settings({
...
var require_queue = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/fastq@1.19.1/node_modules/fastq/queue.js": ((exports, module) => {
	...
	function queueAsPromised(context, worker, _concurrency) {
		...
		return queue;
		function push(value) {
			var p = new Promise(function(resolve$4, reject) {
...
var require_common$1 = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/readers/common.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_async = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/readers/async.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var AsyncReader = class extends AsyncReaderEmitter {
		...
		read(root) {
			...
			const directory = common$4.replacePathSegmentSeparator(root, this.#settings.pathSegmentSeparator);
		...
		#handleError(error) {
			if (this.#isDestroyed || !common$4.isFatalError(this.#settings, error)) return;
		...
		#handleEntry(entry, base) {
			...
			if (base !== void 0) entry.path = common$4.joinPathSegments(base, entry.name, this.#settings.pathSegmentSeparator);
			if (common$4.isAppliedFilter(this.#settings.entryFilter, entry)) this._emitEntry(entry);
			if (entry.dirent.isDirectory() && common$4.isAppliedFilter(this.#settings.deepFilter, entry)) this.#pushToQueue(fullpath, base === void 0 ? void 0 : entry.path);
		}
	};
...
var require_sync = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/readers/sync.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	...
	var SyncReader = class {
		...
		read(root) {
			const directory = common$3.replacePathSegmentSeparator(root, this.#settings.pathSegmentSeparator);
			this.#pushToQueue(directory, this.#settings.basePath);
			this.#handleQueue();
			return this.#storage;
		}
		...
		#handleError(error) {
			if (common$3.isFatalError(this.#settings, error)) throw error;
		}
		#handleEntry(entry, base) {
			const fullpath = entry.path;
			if (base !== void 0) entry.path = common$3.joinPathSegments(base, entry.name, this.#settings.pathSegmentSeparator);
			if (common$3.isAppliedFilter(this.#settings.entryFilter, entry)) this.#pushToStorage(entry);
			if (entry.dirent.isDirectory() && common$3.isAppliedFilter(this.#settings.deepFilter, entry)) this.#pushToQueue(fullpath, base === void 0 ? void 0 : entry.path);
		}
		#pushToStorage(entry) {
...
var require_readers = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/readers/index.js": ((exports) => {
...
var require_fs = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/adapters/fs.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
var require_walk = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/walk.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.walk = walk;
	exports.walkSync = walkSync;
	exports.walkStream = walkStream;
	const providers_1 = require_providers();
	const settings_1$1 = require_settings();
	const readers_1 = require_readers();
	const fs$2 = new (require_fs()).FileSystemAdapter();
	function walk(directory, options, callback) {
		...
		const reader = new readers_1.AsyncReader(fs$2, settings);
		new providers_1.AsyncProvider(reader).read(directory, callback_);
	}
	function walkSync(directory, optionsOrSettings) {
		const settings = getSettings(optionsOrSettings);
		const reader = new readers_1.SyncReader(fs$2, settings);
	...
	function getSettings(settingsOrOptions = {}) {
		if (settingsOrOptions instanceof settings_1$1.Settings) return settingsOrOptions;
		return new settings_1$1.Settings(settingsOrOptions);
	}
}) });

//#endregion
//#region node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/index.js
var require_out = /* @__PURE__ */ __commonJS({ "node_modules/.pnpm/@nodelib+fs.walk@3.0.1/node_modules/@nodelib/fs.walk/out/index.js": ((exports) => {
	Object.defineProperty(exports, "__esModule", { value: true });
...
//#endregion
//#region node_modules/.pnpm/@voxpelli+config-array-find-files@1.2.2_@eslint+config-array@0.23.0_patch_hash=9c568392_1ed838faea2391f42a43f06a947b5ffa/node_modules/@voxpelli/config-array-find-files/index.js
...
async function configArrayFindFiles(options) {
	...
	return (await new Promise((resolve$4, reject) => {
...
function pLimit(concurrency) {
	...
	const run = async (fn, resolve$4, args) => {
		activeCount++;
	...
	const enqueue = (fn, resolve$4, args) => {
		queue.enqueue(run.bind(void 0, fn, resolve$4, args));
		(async () => {
			await Promise.resolve();
			if (activeCount < concurrency && queue.size > 0) queue.dequeue()();
		})();
	};
	const generator = (fn, ...args) => new Promise((resolve$4) => {
		enqueue(fn, resolve$4, args);
	});
...
const matchType = (type, stat$2) => type === "both" ? stat$2.isFile() || stat$2.isDirectory() : stat$2[typeMappings[type]]();
const toPath$1 = (urlOrPath) => urlOrPath instanceof URL ? fileURLToPath(urlOrPath) : urlOrPath;
async function locatePath(paths, { cwd: cwd$1 = process$1.cwd(), type = "file", allowSymlinks = true, concurrency, preserveOrder } = {}) {
	checkType(type);
	cwd$1 = toPath$1(cwd$1);
	const statFunction = allowSymlinks ? promises.stat : promises.lstat;
	return pLocate(paths, async (path_) => {
		try {
			return matchType(type, await statFunction(path.resolve(cwd$1, path_)));
		} catch {
			return false;
		}
	}, {
...
function functionFlags(async$2, generator) {
	return SCOPE_FUNCTION | (async$2 ? SCOPE_ASYNC : 0) | (generator ? SCOPE_GENERATOR : 0);
}
...
Parser.prototype.parse = function parse$3() {
...
Parser.parse = function parse$3(input, options) {
...
pp$9.strictDirective = function(start) {
	...
	for (;;) {
		...
		var match$1 = literal.exec(this.input.slice(start));
		if (!match$1) return false;
		if ((match$1[1] || match$1[2]) === "use strict") {
			skipWhiteSpace.lastIndex = start + match$1[0].length;
			var spaceAfter = skipWhiteSpace.exec(this.input), end = spaceAfter.index + spaceAfter[0].length;
			var next = this.input.charAt(end);
			return next === ";" || next === "}" || lineBreak.test(spaceAfter[0]) && !(/[(`.[+\-/*%<>=,?^&]/.test(next) || next === "!" && this.input.charAt(end + 1) === "=");
		}
		start += match$1[0].length;
		skipWhiteSpace.lastIndex = start;
		start += skipWhiteSpace.exec(this.input)[0].length;
...
pp$8.parseForStatement = function(node) {
	...
	var init$3 = awaitAt > -1 ? this.parseExprSubscripts(refDestructuringErrors, "await") : this.parseExpression(true, refDestructuringErrors);
	if (this.type === types$1._in || (isForOf = this.options.ecmaVersion >= 6 && this.isContextual("of"))) {
		if (awaitAt > -1) {
			if (this.type === types$1._in) this.unexpected(awaitAt);
			node.await = true;
		} else if (isForOf && this.options.ecmaVersion >= 8) {
			if (init$3.start === initPos && !containsEsc && init$3.type === "Identifier" && init$3.name === "async") this.unexpected();
			else if (this.options.ecmaVersion >= 9) node.await = false;
		}
		if (startsWithLet && isForOf) this.raise(init$3.start, "The left-hand side of a for-of loop may not start with 'let'.");
		this.toAssignable(init$3, false, refDestructuringErrors);
		this.checkLValPattern(init$3);
		return this.parseForIn(node, init$3);
	} else this.checkExpressionErrors(refDestructuringErrors, true);
	if (awaitAt > -1) this.unexpected(awaitAt);
	return this.parseFor(node, init$3);
};
pp$8.parseForAfterInit = function(node, init$1, awaitAt) {
...
var Node = function Node$2(parser, pos, loc) {
	this.type = "";
	this.start = pos;
	this.end = 0;
...
RegExpValidationState.prototype.at = function at(i$1, forceU) {
	...
	if (!(forceU || this.switchU) || c$1 <= 55295 || c$1 >= 57344 || i$1 + 1 >= l) return c$1;
...
RegExpValidationState.prototype.nextIndex = function nextIndex(i$1, forceU) {
	...
	if (!(forceU || this.switchU) || c$1 <= 55295 || c$1 >= 57344 || i$1 + 1 >= l || (next = s$1.charCodeAt(i$1 + 1)) < 56320 || next > 57343) return i$1 + 1;
	return i$1 + 2;
};
...
function withTrailingSlash(input = "", respectQueryAndFragment) {
	...
	if (fragmentIndex !== -1) {
		path$4 = input.slice(0, fragmentIndex);
		fragment = input.slice(fragmentIndex);
		if (!path$4) return fragment;
	}
	const [s0, ...s$1] = path$4.split("?");
...
function normalizeSlash(path$4) {
	return path$4.replace(/\\/g, "/");
}
/**
...
codes.ERR_INVALID_PACKAGE_CONFIG = createError(
	...
	*/
	(path$4, base, message) => {
		return `Invalid package config ${path$4}${base ? ` while importing ${base}` : ""}${message ? `. ${message}` : ""}`;
	},
	Error
);
...
codes.ERR_MODULE_NOT_FOUND = createError(
	...
	*/
	(path$4, base, exactUrl = false) => {
		return `Cannot find ${exactUrl ? "module" : "package"} '${path$4}' imported from ${base}`;
	},
	Error
);
...
codes.ERR_UNKNOWN_FILE_EXTENSION = createError(
	...
	*/
	(extension, path$4) => {
		return `Unknown file extension "${extension}" for ${path$4}`;
	},
	TypeError
);
...
function getFileProtocolModuleFormat(url, _context, ignoreErrors) {
	...
	const format$3 = extensionFormatMap[value];
	if (format$3) return format$3;
...
*/
function tryStatSync(path$4) {
	try {
		return statSync(path$4);
	} catch {}
}
/**
...
//#endregion
//#region node_modules/.pnpm/@eslint+config-array@0.23.0_patch_hash=9c56839266cb75a04e2a96a342456c69afd7549bf6c13a9ade49cc6d42de892a/node_modules/@eslint/config-array/dist/esm/std__path/posix.js
...
function stripSuffix$1(name, suffix) {
	...
	for (let i$1 = suffix.length - 1; i$1 >= 0; --i$1) if (name.charCodeAt(lenDiff + i$1) !== suffix.charCodeAt(i$1)) return name;
	return name.slice(0, -suffix.length);
}
function lastPathSegment$1(path$4, isSep, start = 0) {
	let matchedNonSeparator = false;
	let end = path$4.length;
	for (let i$1 = path$4.length - 1; i$1 >= start; --i$1) if (isSep(path$4.charCodeAt(i$1))) {
...
function assertArgs$1$1(path$4, suffix) {
	assertPath$1(path$4);
	if (path$4.length === 0) return path$4;
...
function stripTrailingSeparators$1(segment, isSep) {
	...
	for (let i$1 = segment.length - 1; i$1 > 0; i$1--) if (isSep(segment.charCodeAt(i$1))) end = i$1;
	else break;
...
*/ function basename$2(path$4, suffix = "") {
	if (path$4 instanceof URL) path$4 = fromFileUrl$1(path$4);
	assertArgs$1$1(path$4, suffix);
	const strippedSegment = stripTrailingSeparators$1(lastPathSegment$1(path$4, isPosixPathSeparator$1), isPosixPathSeparator$1);
...
*/ function dirname$2(path$4) {
	if (path$4 instanceof URL) path$4 = fromFileUrl$1(path$4);
	assertArg$2$1(path$4);
	let end = -1;
	let matchedNonSeparator = false;
	for (let i$1 = path$4.length - 1; i$1 >= 1; --i$1) if (isPosixPathSeparator$1(path$4.charCodeAt(i$1))) {
		if (matchedNonSeparator) {
			end = i$1;
			break;
		}
	} else matchedNonSeparator = true;
	if (end === -1) return isPosixPathSeparator$1(path$4.charCodeAt(0)) ? "/" : ".";
	return stripTrailingSeparators$1(path$4.slice(0, end), isPosixPathSeparator$1);
}
/**
...
*/ function extname$1(path$4) {
	...
	let preDotState = 0;
	for (let i$1 = path$4.length - 1; i$1 >= 0; --i$1) {
		const code = path$4.charCodeAt(i$1);
...
function _format$1(sep$1, pathObject) {
	const dir = pathObject.dir || pathObject.root;
	const base = pathObject.base || (pathObject.name ?? "") + (pathObject.ext ?? "");
	if (!dir) return base;
	if (base === sep$1) return dir;
...
*/ function isAbsolute$1(path$4) {
	assertPath$1(path$4);
	return path$4.length > 0 && isPosixPathSeparator$1(path$4.charCodeAt(0));
}
function assertArg$4(path$4) {
	assertPath$1(path$4);
	if (path$4.length === 0) return ".";
}
function normalizeString$1(path$4, allowAboveRoot, separator, isPathSeparator$1) {
	let res = "";
	let lastSegmentLength = 0;
	let lastSlash = -1;
	let dots = 0;
	let code;
	for (let i$1 = 0; i$1 <= path$4.length; ++i$1) {
		if (i$1 < path$4.length) code = path$4.charCodeAt(i$1);
		else if (isPathSeparator$1(code)) break;
		else code = CHAR_FORWARD_SLASH$1;
		if (isPathSeparator$1(code)) {
			if (lastSlash === i$1 - 1 || dots === 1);
			else if (lastSlash !== i$1 - 1 && dots === 2) {
				...
				if (res.length > 0) res += separator + path$4.slice(lastSlash + 1, i$1);
				else res = path$4.slice(lastSlash + 1, i$1);
...
*/ function normalize$3(path$4) {
	if (path$4 instanceof URL) path$4 = fromFileUrl$1(path$4);
	assertArg$4(path$4);
	const isAbsolute$3 = isPosixPathSeparator$1(path$4.charCodeAt(0));
	const trailingSeparator = isPosixPathSeparator$1(path$4.charCodeAt(path$4.length - 1));
	path$4 = normalizeString$1(path$4, !isAbsolute$3, "/", isPosixPathSeparator$1);
	if (path$4.length === 0 && !isAbsolute$3) path$4 = ".";
	if (path$4.length > 0 && trailingSeparator) path$4 += "/";
	if (isAbsolute$3) return `/${path$4}`;
	return path$4;
}
/**
...
*/ function join$2(path$4, ...paths) {
	if (path$4 === void 0) return ".";
	if (path$4 instanceof URL) path$4 = fromFileUrl$1(path$4);
	paths = path$4 ? [path$4, ...paths] : paths;
	paths.forEach((path$5) => assertPath$1(path$5));
	const joined = paths.filter((path$5) => path$5.length > 0).join("/");
...
*/ function parse$2(path$4) {
	...
	if (startDot === -1 || end === -1 || preDotState === 0 || preDotState === 1 && startDot === end - 1 && startDot === startPart + 1) {
		if (end !== -1) if (startPart === 0 && isAbsolute$3) ret.base = ret.name = path$4.slice(1, end);
		else ret.base = ret.name = path$4.slice(startPart, end);
		ret.base = ret.base || "/";
	} else {
		if (startPart === 0 && isAbsolute$3) {
	...
	if (startPart > 0) ret.dir = stripTrailingSeparators$1(path$4.slice(0, startPart - 1), isPosixPathSeparator$1);
	else if (isAbsolute$3) ret.dir = "/";
	return ret;
}
/**
...
*/ function resolve$3(...pathSegments) {
	let resolvedPath = "";
	let resolvedAbsolute = false;
	for (let i$1 = pathSegments.length - 1; i$1 >= -1 && !resolvedAbsolute; i$1--) {
		let path$4;
		if (i$1 >= 0) path$4 = pathSegments[i$1];
		else {
		...
		resolvedPath = `${path$4}/${resolvedPath}`;
		resolvedAbsolute = isPosixPathSeparator$1(path$4.charCodeAt(0));
	}
...
*/ function relative$2(from, to) {
	...
	for (; i$1 <= length; ++i$1) {
		if (i$1 === length) {
			if (toLen > length) {
				if (isPosixPathSeparator$1(to.charCodeAt(toStart + i$1))) return to.slice(toStart + i$1 + 1);
				else if (i$1 === 0) return to.slice(toStart + i$1);
			} else if (fromLen > length) {
				if (isPosixPathSeparator$1(from.charCodeAt(fromStart + i$1))) lastCommonSep = i$1;
				else if (i$1 === 0) lastCommonSep = 0;
			}
			break;
		}
		const fromCode = from.charCodeAt(fromStart + i$1);
		if (fromCode !== to.charCodeAt(toStart + i$1)) break;
		else if (isPosixPathSeparator$1(fromCode)) lastCommonSep = i$1;
	}
	let out = "";
	for (i$1 = fromStart + lastCommonSep + 1; i$1 <= fromEnd; ++i$1) if (i$1 === fromEnd || isPosixPathSeparator$1(from.charCodeAt(i$1))) if (out.length === 0) out += "..";
	else out += "/..";
...
function encodeWhitespace$1(string) {
	return string.replaceAll(/[\s]/g, (c$1) => {
		return WHITESPACE_ENCODINGS$1[c$1] ?? c$1;
	});
}
/**
...
*/ function toFileUrl$1(path$4) {
	if (!isAbsolute$1(path$4)) throw new TypeError(`Path must be absolute: received "${path$4}"`);
	const url = new URL("file:///");
	url.pathname = encodeWhitespace$1(path$4.replace(/%/g, "%25").replace(/\\/g, "%5C"));
	return url;
}
/**
...
*/ function toNamespacedPath$1(path$4) {
	return path$4;
}
function common$1$1(paths, sep$1) {
	const [first = "", ...remaining] = paths;
	const parts = first.split(sep$1);
	let endOfPrefix = parts.length;
	let append = "";
	for (const path$4 of remaining) {
		const compare = path$4.split(sep$1);
		if (compare.length <= endOfPrefix) {
			endOfPrefix = compare.length;
			append = "";
		}
		for (let i$1 = 0; i$1 < endOfPrefix; i$1++) if (compare[i$1] !== parts[i$1]) {
			endOfPrefix = i$1;
			append = i$1 === 0 ? "" : sep$1;
			break;
		}
	}
	return parts.slice(0, endOfPrefix).join(sep$1) + append;
}
...
function _globToRegExp$1(c$1, glob$1, { extended = true, globstar: globstarOption = true, caseInsensitive = false } = {}) {
	if (glob$1 === "") return /(?!)/;
	let newLength = glob$1.length;
	for (; newLength > 1 && c$1.seps.includes(glob$1[newLength - 1]); newLength--);
	glob$1 = glob$1.slice(0, newLength);
	let regExpString = "";
	for (let j = 0; j < glob$1.length;) {
		let segment = "";
		const groupStack = [];
		let inRange = false;
		let inEscape = false;
		...
		let i$1 = j;
		for (; i$1 < glob$1.length && !c$1.seps.includes(glob$1[i$1]); i$1++) {
			if (inEscape) {
				inEscape = false;
				segment += (inRange ? RANGE_ESCAPE_CHARS$1 : REG_EXP_ESCAPE_CHARS$1).includes(glob$1[i$1]) ? `\\${glob$1[i$1]}` : glob$1[i$1];
				continue;
			}
			if (glob$1[i$1] === c$1.escapePrefix) {
				inEscape = true;
				continue;
			}
			if (glob$1[i$1] === "[") {
				if (!inRange) {
					...
					let k = i$1 + 1;
					let value = "";
					while (glob$1[k + 1] !== void 0 && glob$1[k + 1] !== ":") {
						value += glob$1[k + 1];
						k++;
					}
					if (glob$1[k + 1] === ":" && glob$1[k + 2] === "]") {
						i$1 = k + 2;
			...
			if (glob$1[i$1] === ")" && groupStack.length > 0 && groupStack[groupStack.length - 1] !== "BRACE") {
				segment += ")";
				const type = groupStack.pop();
				if (type === "!") segment += c$1.wildcard;
			...
			if (glob$1[i$1] === "+" && extended && glob$1[i$1 + 1] === "(") {
				i$1++;
				groupStack.push("+");
				segment += "(?:";
				continue;
			...
			if (glob$1[i$1] === "}" && groupStack[groupStack.length - 1] === "BRACE") {
				groupStack.pop();
				segment += ")";
				continue;
			}
			...
			if (glob$1[i$1] === "*") {
				if (extended && glob$1[i$1 + 1] === "(") {
					...
					const prevChar = glob$1[i$1 - 1];
					let numStars = 1;
					while (glob$1[i$1 + 1] === "*") {
						i$1++;
						numStars++;
					}
					const nextChar = glob$1[i$1 + 1];
					if (globstarOption && numStars === 2 && [...c$1.seps, void 0].includes(prevChar) && [...c$1.seps, void 0].includes(nextChar)) {
						segment += c$1.globstar;
						endsWithSep = true;
					} else segment += c$1.wildcard;
				}
				continue;
			}
			segment += REG_EXP_ESCAPE_CHARS$1.includes(glob$1[i$1]) ? `\\${glob$1[i$1]}` : glob$1[i$1];
		}
		if (groupStack.length > 0 || inRange || inEscape) {
			segment = "";
			for (const c$2 of glob$1.slice(j, i$1)) {
				segment += REG_EXP_ESCAPE_CHARS$1.includes(c$2) ? `\\${c$2}` : c$2;
				endsWithSep = false;
			}
		}
		regExpString += segment;
		if (!endsWithSep) {
			regExpString += i$1 < glob$1.length ? c$1.sep : c$1.sepMaybe;
			endsWithSep = true;
		}
		while (c$1.seps.includes(glob$1[i$1])) i$1++;
		j = i$1;
	}
...
*/ function globToRegExp$1(glob$1, options = {}) {
	return _globToRegExp$1(constants$2, glob$1, options);
}
/**
...
*/ function isGlob$1(str) {
	...
	if (str === "") return false;
	let match$1;
	while (match$1 = regex.exec(str)) {
		if (match$1[2]) return true;
		let idx = match$1.index + match$1[0].length;
		const open$1 = match$1[1];
		const close = open$1 ? chars[open$1] : null;
		if (open$1 && close) {
...
* @returns The normalized path.
*/ function normalizeGlob$1(glob$1, options = {}) {
	const { globstar = false } = options;
	if (glob$1.match(/\0/g)) throw new Error(`Glob contains invalid characters: "${glob$1}"`);
	if (!globstar) return normalize$3(glob$1);
	const s$1 = SEPARATOR_PATTERN$1.source;
	const badParentPattern = new RegExp(`(?<=(${s$1}|^)\\*\\*${s$1})\\.\\.(?=${s$1}|$)`, "g");
	return normalize$3(glob$1.replace(badParentPattern, "\0")).replace(/\0/g, "..");
}
/**
...
*/ function joinGlobs$1(globs, options = {}) {
	const { globstar = false } = options;
	if (!globstar || globs.length === 0) return join$2(...globs);
	let joined;
	for (const glob$1 of globs) {
		const path$4 = glob$1;
		if (path$4.length > 0) if (!joined) joined = path$4;
		else joined += `${SEPARATOR$1}${path$4}`;
	}
	if (!joined) return ".";
...
//#endregion
//#region node_modules/.pnpm/@eslint+config-array@0.23.0_patch_hash=9c56839266cb75a04e2a96a342456c69afd7549bf6c13a9ade49cc6d42de892a/node_modules/@eslint/config-array/dist/esm/std__path/windows.js
...
function lastPathSegment(path$4, isSep, start = 0) {
	let matchedNonSeparator = false;
	let end = path$4.length;
	for (let i$1 = path$4.length - 1; i$1 >= start; --i$1) if (isSep(path$4.charCodeAt(i$1))) {
		if (matchedNonSeparator) {
...
function assertArgs$1(path$4, suffix) {
	assertPath(path$4);
	if (path$4.length === 0) return path$4;
	if (typeof suffix !== "string") throw new TypeError(`Suffix must be a string, received "${JSON.stringify(suffix)}"`);
}
...
*/ function fromFileUrl(url) {
	url = assertArg$3(url);
	let path$4 = decodeURIComponent(url.pathname.replace(/\//g, "\\").replace(/%(?![0-9A-Fa-f]{2})/g, "%25")).replace(/^\\*([A-Za-z]:)(\\|$)/, "$1\\");
	if (url.hostname !== "") path$4 = `\\\\${url.hostname}${path$4}`;
	return path$4;
}
/**
* Return the last portion of a `path`.
...
* @param suffix The suffix to remove from extracted name.
* @returns The extracted name.
*/ function basename$1(path$4, suffix = "") {
	if (path$4 instanceof URL) path$4 = fromFileUrl(path$4);
	assertArgs$1(path$4, suffix);
	let start = 0;
	if (path$4.length >= 2) {
		if (isWindowsDeviceRoot(path$4.charCodeAt(0))) {
			if (path$4.charCodeAt(1) === CHAR_COLON) start = 2;
		}
	}
	const strippedSegment = stripTrailingSeparators(lastPathSegment(path$4, isPathSeparator, start), isPathSeparator);
...
* @param path The path to get the directory from.
* @returns The directory path.
*/ function dirname$1(path$4) {
	if (path$4 instanceof URL) path$4 = fromFileUrl(path$4);
	assertArg$2(path$4);
	const len = path$4.length;
	let rootEnd = -1;
	let end = -1;
	let matchedSlash = true;
	let offset = 0;
	const code = path$4.charCodeAt(0);
	if (len > 1) {
		if (isPathSeparator(code)) {
			rootEnd = offset = 1;
			if (isPathSeparator(path$4.charCodeAt(1))) {
				let j = 2;
				let last = j;
				for (; j < len; ++j) if (isPathSeparator(path$4.charCodeAt(j))) break;
				if (j < len && j !== last) {
					last = j;
					for (; j < len; ++j) if (!isPathSeparator(path$4.charCodeAt(j))) break;
					if (j < len && j !== last) {
						last = j;
						for (; j < len; ++j) if (isPathSeparator(path$4.charCodeAt(j))) break;
						if (j === len) return path$4;
						if (j !== last) rootEnd = offset = j + 1;
					}
				}
			}
		} else if (isWindowsDeviceRoot(code)) {
			if (path$4.charCodeAt(1) === CHAR_COLON) {
				rootEnd = offset = 2;
				if (len > 2) {
					if (isPathSeparator(path$4.charCodeAt(2))) rootEnd = offset = 3;
				}
			}
		}
	} else if (isPathSeparator(code)) return path$4;
	for (let i$1 = len - 1; i$1 >= offset; --i$1) if (isPathSeparator(path$4.charCodeAt(i$1))) {
		if (!matchedSlash) {
			end = i$1;
			break;
		}
	...
	return stripTrailingSeparators(path$4.slice(0, end), isPosixPathSeparator);
}
/**
* Return the extension of the `path` with leading period.
*
...
*/ function extname(path$4) {
	...
	let matchedSlash = true;
	let preDotState = 0;
	if (path$4.length >= 2 && path$4.charCodeAt(1) === CHAR_COLON && isWindowsDeviceRoot(path$4.charCodeAt(0))) start = startPart = 2;
	for (let i$1 = path$4.length - 1; i$1 >= start; --i$1) {
		const code = path$4.charCodeAt(i$1);
		if (isPathSeparator(code)) {
			if (!matchedSlash) {
				startPart = i$1 + 1;
...
*/ function isAbsolute(path$4) {
	...
	if (isPathSeparator(code)) return true;
		...
		if (len > 2 && path$4.charCodeAt(1) === CHAR_COLON) {
			if (isPathSeparator(path$4.charCodeAt(2))) return true;
		}
	}
	return false;
}
function assertArg(path$4) {
	assertPath(path$4);
	if (path$4.length === 0) return ".";
}
function normalizeString(path$4, allowAboveRoot, separator, isPathSeparator$1) {
	let res = "";
	let lastSegmentLength = 0;
	let lastSlash = -1;
	let dots = 0;
...
* @param path The path to normalize
* @returns The normalized path
*/ function normalize$2(path$4) {
	if (path$4 instanceof URL) path$4 = fromFileUrl(path$4);
	assertArg(path$4);
	const len = path$4.length;
	let rootEnd = 0;
	let device;
	let isAbsolute$3 = false;
	const code = path$4.charCodeAt(0);
	if (len > 1) {
		if (isPathSeparator(code)) {
			isAbsolute$3 = true;
			if (isPathSeparator(path$4.charCodeAt(1))) {
				...
				for (; j < len; ++j) if (isPathSeparator(path$4.charCodeAt(j))) break;
				if (j < len && j !== last) {
					const firstPart = path$4.slice(last, j);
					last = j;
					for (; j < len; ++j) if (!isPathSeparator(path$4.charCodeAt(j))) break;
					if (j < len && j !== last) {
						last = j;
						for (; j < len; ++j) if (isPathSeparator(path$4.charCodeAt(j))) break;
						if (j === len) return `\\\\${firstPart}\\${path$4.slice(last)}\\`;
						else if (j !== last) {
							device = `\\\\${firstPart}\\${path$4.slice(last, j)}`;
							rootEnd = j;
						}
					}
				}
			...
			if (path$4.charCodeAt(1) === CHAR_COLON) {
				device = path$4.slice(0, 2);
				rootEnd = 2;
				if (len > 2) {
					if (isPathSeparator(path$4.charCodeAt(2))) {
						isAbsolute$3 = true;
						rootEnd = 3;
					}
				}
	...
	let tail;
	if (rootEnd < len) tail = normalizeString(path$4.slice(rootEnd), !isAbsolute$3, "\\", isPathSeparator);
	else tail = "";
	if (tail.length === 0 && !isAbsolute$3) tail = ".";
	if (tail.length > 0 && isPathSeparator(path$4.charCodeAt(len - 1))) tail += "\\";
	if (device === void 0) {
		if (isAbsolute$3) if (tail.length > 0) return `\\${tail}`;
		else return "\\";
		return tail;
	} else if (isAbsolute$3) if (tail.length > 0) return `${device}\\${tail}`;
	else return `${device}\\`;
	return device + tail;
}
/**
...
* @param paths The paths to join.
* @returns The joined path.
*/ function join$1(path$4, ...paths) {
	if (path$4 instanceof URL) path$4 = fromFileUrl(path$4);
	paths = path$4 ? [path$4, ...paths] : paths;
	paths.forEach((path$5) => assertPath(path$5));
	paths = paths.filter((path$5) => path$5.length > 0);
...
*/ function parse$1(path$4) {
	...
	if (rootEnd > 0) ret.root = path$4.slice(0, rootEnd);
	let startDot = -1;
	...
	if (startDot === -1 || end === -1 || preDotState === 0 || preDotState === 1 && startDot === end - 1 && startDot === startPart + 1) {
		if (end !== -1) ret.base = ret.name = path$4.slice(startPart, end);
	} else {
		ret.name = path$4.slice(startPart, startDot);
		ret.base = path$4.slice(startPart, end);
		ret.ext = path$4.slice(startDot, end);
	...
	ret.base = ret.base || "\\";
	if (startPart > 0 && startPart !== rootEnd) ret.dir = path$4.slice(0, startPart - 1);
...
*/ function resolve$2(...pathSegments) {
	...
	let resolvedTail = "";
	let resolvedAbsolute = false;
	for (let i$1 = pathSegments.length - 1; i$1 >= -1; i$1--) {
		let path$4;
		const { Deno } = globalThis;
		if (i$1 >= 0) path$4 = pathSegments[i$1];
			...
			path$4 = Deno.cwd();
			if (path$4 === void 0 || path$4.slice(0, 3).toLowerCase() !== `${resolvedDevice.toLowerCase()}\\`) path$4 = `${resolvedDevice}\\`;
		}
		assertPath(path$4);
		const len = path$4.length;
		if (len === 0) continue;
				...
				if (isPathSeparator(path$4.charCodeAt(1))) {
					...
					if (j < len && j !== last) {
						...
						if (j < len && j !== last) {
							...
							for (; j < len; ++j) if (isPathSeparator(path$4.charCodeAt(j))) break;
							if (j === len) {
								device = `\\\\${firstPart}\\${path$4.slice(last)}`;
								rootEnd = j;
							} else if (j !== last) {
								device = `\\\\${firstPart}\\${path$4.slice(last, j)}`;
								rootEnd = j;
		...
		if (!resolvedAbsolute) {
			resolvedTail = `${path$4.slice(rootEnd)}\\${resolvedTail}`;
			resolvedAbsolute = isAbsolute$3;
		}
...
*/ function relative$1(from, to) {
	...
	for (; i$1 <= length; ++i$1) {
		if (i$1 === length) {
			if (toLen > length) {
				if (to.charCodeAt(toStart + i$1) === CHAR_BACKWARD_SLASH) return toOrig.slice(toStart + i$1 + 1);
				else if (i$1 === 2) return toOrig.slice(toStart + i$1);
			}
			if (fromLen > length) {
				if (from.charCodeAt(fromStart + i$1) === CHAR_BACKWARD_SLASH) lastCommonSep = i$1;
				else if (i$1 === 2) lastCommonSep = 3;
			}
			break;
		}
		const fromCode = from.charCodeAt(fromStart + i$1);
		if (fromCode !== to.charCodeAt(toStart + i$1)) break;
		else if (fromCode === CHAR_BACKWARD_SLASH) lastCommonSep = i$1;
	}
	if (i$1 !== length && lastCommonSep === -1) return toOrig;
	let out = "";
	if (lastCommonSep === -1) lastCommonSep = 0;
	for (i$1 = fromStart + lastCommonSep + 1; i$1 <= fromEnd; ++i$1) if (i$1 === fromEnd || from.charCodeAt(i$1) === CHAR_BACKWARD_SLASH) if (out.length === 0) out += "..";
	else out += "\\..";
...
function encodeWhitespace(string) {
	return string.replaceAll(/[\s]/g, (c$1) => {
		return WHITESPACE_ENCODINGS[c$1] ?? c$1;
	});
}
/**
* Converts a path string to a file URL.
...
* @param path The path to convert.
* @returns The file URL.
*/ function toFileUrl(path$4) {
	if (!isAbsolute(path$4)) throw new TypeError(`Path must be absolute: received "${path$4}"`);
	const [, hostname, pathname] = path$4.match(/^(?:[/\\]{2}([^/\\]+)(?=[/\\](?:[^/\\]|$)))?(.*)/);
	const url = new URL("file:///");
...
*/ function toNamespacedPath(path$4) {
	if (typeof path$4 !== "string") return path$4;
	if (path$4.length === 0) return "";
	const resolvedPath = resolve$2(path$4);
...
function _globToRegExp(c$1, glob$1, { extended = true, globstar: globstarOption = true, caseInsensitive = false } = {}) {
	if (glob$1 === "") return /(?!)/;
	let newLength = glob$1.length;
	for (; newLength > 1 && c$1.seps.includes(glob$1[newLength - 1]); newLength--);
	glob$1 = glob$1.slice(0, newLength);
	...
	for (let j = 0; j < glob$1.length;) {
		...
		for (; i$1 < glob$1.length && !c$1.seps.includes(glob$1[i$1]); i$1++) {
			if (inEscape) {
				inEscape = false;
				segment += (inRange ? RANGE_ESCAPE_CHARS : REG_EXP_ESCAPE_CHARS).includes(glob$1[i$1]) ? `\\${glob$1[i$1]}` : glob$1[i$1];
				continue;
			}
			if (glob$1[i$1] === c$1.escapePrefix) {
				inEscape = true;
			...
			segment += REG_EXP_ESCAPE_CHARS.includes(glob$1[i$1]) ? `\\${glob$1[i$1]}` : glob$1[i$1];
		}
		if (groupStack.length > 0 || inRange || inEscape) {
			segment = "";
			for (const c$2 of glob$1.slice(j, i$1)) {
				segment += REG_EXP_ESCAPE_CHARS.includes(c$2) ? `\\${c$2}` : c$2;
				endsWithSep = false;
			}
		}
		regExpString += segment;
...
* @param options Conversion options.
* @returns The regular expression equivalent to the glob.
*/ function globToRegExp(glob$1, options = {}) {
	return _globToRegExp(constants$1, glob$1, options);
}
/**
* Test whether the given string is a glob.
*
...
*/ function normalizeGlob(glob$1, options = {}) {
	const { globstar = false } = options;
	if (glob$1.match(/\0/g)) throw new Error(`Glob contains invalid characters: "${glob$1}"`);
	if (!globstar) return normalize$2(glob$1);
	const s$1 = SEPARATOR_PATTERN.source;
	const badParentPattern = new RegExp(`(?<=(${s$1}|^)\\*\\*${s$1})\\.\\.(?=${s$1}|$)`, "g");
	return normalize$2(glob$1.replace(badParentPattern, "\0")).replace(/\0/g, "..");
}
/**
* Like join(), but doesn't collapse "**\/.." when `globstar` is true.
*
...
const balanced = (a, b, str) => {
	...
	const r$1 = ma !== null && mb != null && range(ma, mb, str);
	return r$1 && {
		start: r$1[0],
		end: r$1[1],
		pre: str.slice(0, r$1[0]),
		body: str.slice(r$1[0] + ma.length, r$1[1]),
		post: str.slice(r$1[1] + mb.length)
	};
};
const maybeMatch = (reg, str) => {
	const m$1 = str.match(reg);
...
function parseCommaParts(str) {
	if (!str) return [""];
	const parts = [];
	const m$1 = balanced("{", "}", str);
	if (!m$1) return str.split(",");
	const { pre, body, post } = m$1;
	const p = pre.split(",");
	p[p.length - 1] += "{" + body + "}";
...
function lte(i$1, y$1) {
	return i$1 <= y$1;
}
function gte(i$1, y$1) {
	return i$1 >= y$1;
}
function expand_(str, isTop) {
	...
	if (!m$1) return [str];
	const pre = m$1.pre;
	const post = m$1.post.length ? expand_(m$1.post, false) : [""];
	if (/\$$/.test(m$1.pre)) for (let k = 0; k < post.length; k++) {
		const expansion = pre + "{" + m$1.body + "}" + post[k];
		expansions.push(expansion);
	}
	else {
		const isNumericSequence = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(m$1.body);
		const isAlphaSequence = /^[a-zA-Z]\.\.[a-zA-Z](?:\.\.-?\d+)?$/.test(m$1.body);
		const isSequence = isNumericSequence || isAlphaSequence;
		const isOptions = m$1.body.indexOf(",") >= 0;
		...
		if (isSequence) n = m$1.body.split(/\.\./);
			...
			if (n.length === 1 && n[0] !== void 0) {
				...
				/* c8 ignore start */
				if (n.length === 1) return post.map((p) => m$1.pre + n[0] + p);
			}
		}
		let N;
		if (isSequence && n[0] !== void 0 && n[1] !== void 0) {
			const x = numeric(n[0]);
			const y$1 = numeric(n[1]);
			...
			N = [];
			for (let i$1 = x; test(i$1, y$1); i$1 += incr) {
				let c$1;
				if (isAlphaSequence) {
					c$1 = String.fromCharCode(i$1);
					if (c$1 === "\\") c$1 = "";
				} else {
					c$1 = String(i$1);
					if (pad) {
						const need = width - c$1.length;
						if (need > 0) {
							const z = new Array(need + 1).join("0");
							if (i$1 < 0) c$1 = "-" + z + c$1.slice(1);
							else c$1 = z + c$1;
						}
					}
				}
...
const braceEscape = (s$1) => s$1.replace(/[[\]\\-]/g, "\\$&");
const regexpEscape = (s$1) => s$1.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
...
const parseClass = (glob$1, position) => {
	...
	let endPos = pos;
	let rangeStart = "";
	WHILE: while (i$1 < glob$1.length) {
		const c$1 = glob$1.charAt(i$1);
		if ((c$1 === "!" || c$1 === "^") && i$1 === pos + 1) {
			negate = true;
			i$1++;
			continue;
		}
		if (c$1 === "]" && sawStart && !escaping) {
			endPos = i$1 + 1;
			break;
		}
		sawStart = true;
		...
		if (c$1 === "[" && !escaping) {
			for (const [cls, [unip, u, neg]] of Object.entries(posixClasses)) if (glob$1.startsWith(cls, i$1)) {
		...
		escaping = false;
		if (rangeStart) {
			if (c$1 > rangeStart) ranges.push(braceEscape(rangeStart) + "-" + braceEscape(c$1));
			else if (c$1 === rangeStart) ranges.push(braceEscape(c$1));
			rangeStart = "";
			i$1++;
			continue;
		}
		if (glob$1.startsWith("-]", i$1 + 1)) {
			ranges.push(braceEscape(c$1 + "-"));
			i$1 += 2;
			continue;
		}
		if (glob$1.startsWith("-", i$1 + 1)) {
...
* unescaped.
*/
const unescape = (s$1, { windowsPathsNoEscape = false, magicalBraces = true } = {}) => {
	if (magicalBraces) return windowsPathsNoEscape ? s$1.replace(/\[([^\/\\])\]/g, "$1") : s$1.replace(/((?!\\).|^)\[([^\/\\])\]/g, "$1$2").replace(/\\([^\/])/g, "$1");
	return windowsPathsNoEscape ? s$1.replace(/\[([^\/\\{}])\]/g, "$1") : s$1.replace(/((?!\\).|^)\[([^\/\\{}])\]/g, "$1$2").replace(/\\([^\/{}])/g, "$1");
};
...
const isExtglobType = (c$1) => types.has(c$1);
const startNoTraversal = "(?!(?:^|/)\\.\\.?(?:$|/))";
const startNoDot = "(?!\\.)";
const addPatternStart = new Set(["[", "."]);
const justDots = new Set(["..", "."]);
const reSpecials = /* @__PURE__ */ new Set("().*{}+?[]^$\\!");
const regExpEscape$1 = (s$1) => s$1.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, "\\$&");
const qmark = "[^/]";
const star$1 = qmark + "*?";
...
var AST = class AST {
	...
	#fillNegs() {
		...
		while (n = this.#negs.pop()) {
			...
			let pp$10 = p.#parent;
			while (pp$10) {
				for (let i$1 = p.#parentIndex + 1; !pp$10.type && i$1 < pp$10.#parts.length; i$1++) for (const part of n.#parts) {
					/* c8 ignore start */
					if (typeof part === "string") throw new Error("string part in extglob AST??");
					/* c8 ignore stop */
					part.copyIn(pp$10.#parts[i$1]);
				}
				p = pp$10;
				pp$10 = p.#parent;
			}
	...
	isStart() {
		...
		for (let i$1 = 0; i$1 < this.#parentIndex; i$1++) {
			const pp$10 = p.#parts[i$1];
			if (!(pp$10 instanceof AST && pp$10.type === "!")) return false;
		}
		return true;
	}
	isEnd() {
	...
	clone(parent) {
		const c$1 = new AST(this.type, parent);
		for (const p of this.#parts) c$1.copyIn(p);
		return c$1;
	}
	static #parseAST(str, ast, pos, opt) {
		...
		if (ast.type === null) {
			...
			while (i$2 < str.length) {
				...
				if (inBrace) {
					if (i$2 === braceStart + 1) {
						if (c$1 === "^" || c$1 === "!") braceNeg = true;
					} else if (c$1 === "]" && !(i$2 === braceStart + 2 && braceNeg)) inBrace = false;
					acc$1 += c$1;
					continue;
				} else if (c$1 === "[") {
					inBrace = true;
				...
				if (!opt.noext && isExtglobType(c$1) && str.charAt(i$2) === "(") {
					ast.push(acc$1);
					acc$1 = "";
					const ext$1 = new AST(c$1, ast);
					i$2 = AST.#parseAST(str, ext$1, i$2, opt);
					ast.push(ext$1);
					continue;
				}
				acc$1 += c$1;
		...
		while (i$1 < str.length) {
			...
			if (inBrace) {
				if (i$1 === braceStart + 1) {
					if (c$1 === "^" || c$1 === "!") braceNeg = true;
				} else if (c$1 === "]" && !(i$1 === braceStart + 2 && braceNeg)) inBrace = false;
				acc += c$1;
				continue;
			} else if (c$1 === "[") {
				inBrace = true;
			...
			if (isExtglobType(c$1) && str.charAt(i$1) === "(") {
				part.push(acc);
				acc = "";
				const ext$1 = new AST(c$1, part);
				part.push(ext$1);
	...
	toMMPattern() {
		...
		if (!(hasMagic || this.#hasMagic || this.#options.nocase && !this.#options.nocaseMagicOnly && glob$1.toUpperCase() !== glob$1.toLowerCase())) return body;
	...
	toRegExpSource(allowDot) {
		...
		if (!this.type) {
			const noEmpty = this.isStart() && this.isEnd() && !this.#parts.some((s$1) => typeof s$1 !== "string");
	...
	static #parseGlob(glob$1, hasMagic, noEmpty = false) {
		let escaping = false;
		let re = "";
		let uflag = false;
		for (let i$1 = 0; i$1 < glob$1.length; i$1++) {
			const c$1 = glob$1.charAt(i$1);
			if (escaping) {
				escaping = false;
				re += (reSpecials.has(c$1) ? "\\" : "") + c$1;
				continue;
			}
			if (c$1 === "\\") {
				if (i$1 === glob$1.length - 1) re += "\\\\";
				else escaping = true;
				continue;
			}
			if (c$1 === "[") {
				const [src, needUflag, consumed, magic] = parseClass(glob$1, i$1);
				if (consumed) {
					re += src;
...
*/
const escape = (s$1, { windowsPathsNoEscape = false, magicalBraces = false } = {}) => {
	if (magicalBraces) return windowsPathsNoEscape ? s$1.replace(/[?*()[\]{}]/g, "[$&]") : s$1.replace(/[?*()[\]\\{}]/g, "\\$&");
	return windowsPathsNoEscape ? s$1.replace(/[?*()[\]]/g, "[$&]") : s$1.replace(/[?*()[\]\\]/g, "\\$&");
};
...
const defaults = (def) => {
	...
	const m$1 = (p, pattern, options = {}) => orig(p, pattern, ext(def, options));
	return Object.assign(m$1, {
		...
		unescape: (s$1, options = {}) => orig.unescape(s$1, ext(def, options)),
		escape: (s$1, options = {}) => orig.escape(s$1, ext(def, options)),
...
var Minimatch = class {
	...
	make() {
		...
		const rawGlobParts = this.globSet.map((s$1) => this.slashSplit(s$1));
		this.globParts = this.preprocess(rawGlobParts);
		this.debug(this.pattern, this.globParts);
		let set = this.globParts.map((s$1, _, __) => {
			if (this.isWindows && this.windowsNoMagicRoot) {
				const isUNC = s$1[0] === "" && s$1[1] === "" && (s$1[2] === "?" || !globMagic.test(s$1[2])) && !globMagic.test(s$1[3]);
				const isDrive = /^[a-z]:/i.test(s$1[0]);
				if (isUNC) return [...s$1.slice(0, 4), ...s$1.slice(4).map((ss) => this.parse(ss))];
				else if (isDrive) return [s$1[0], ...s$1.slice(1).map((ss) => this.parse(ss))];
			}
			return s$1.map((ss) => this.parse(ss));
		});
		this.debug(this.pattern, set);
		this.set = set.filter((s$1) => s$1.indexOf(false) === -1);
	...
	parse(pattern) {
		...
		let m$1;
		let fastTest = null;
		if (m$1 = pattern.match(starRE)) fastTest = options.dot ? starTestDot : starTest;
		else if (m$1 = pattern.match(starDotExtRE)) fastTest = (options.nocase ? options.dot ? starDotExtTestNocaseDot : starDotExtTestNocase : options.dot ? starDotExtTestDot : starDotExtTest)(m$1[1]);
		else if (m$1 = pattern.match(qmarksRE)) fastTest = (options.nocase ? options.dot ? qmarksTestNocaseDot : qmarksTestNocase : options.dot ? qmarksTestDot : qmarksTest)(m$1);
		else if (m$1 = pattern.match(starDotStarRE)) fastTest = options.dot ? starDotStarTestDot : starDotStarTest;
		else if (m$1 = pattern.match(dotStarRE)) fastTest = dotStarTest;
	...
	makeRe() {
		...
		let re = set.map((pattern) => {
			...
			pp$10.forEach((p, i$1) => {
				const next = pp$10[i$1 + 1];
				const prev = pp$10[i$1 - 1];
				if (p !== GLOBSTAR || prev === GLOBSTAR) return;
				if (prev === void 0) if (next !== void 0 && next !== GLOBSTAR) pp$10[i$1 + 1] = "(?:\\/|" + twoStar + "\\/)?" + next;
				else pp$10[i$1] = twoStar;
				else if (next === void 0) pp$10[i$1 - 1] = prev + "(?:\\/|\\/" + twoStar + ")?";
				else if (next !== GLOBSTAR) {
					pp$10[i$1 - 1] = prev + "(?:\\/|\\/" + twoStar + "\\/)" + next;
					pp$10[i$1 + 1] = GLOBSTAR;
				}
			});
			const filtered = pp$10.filter((p) => p !== GLOBSTAR);
		...
		re = "^" + open$1 + re + close + "$";
		if (this.partial) re = "^(?:\\/|" + open$1 + re.slice(1, -1) + close + ")$";
		...
		*/
		function createDebug$1(namespace) {
			...
			function debug$1(...args) {
				...
				let index = 0;
				args[0] = args[0].replace(/%([a-zA-Z%])/g, (match$1, format$3) => {
					if (match$1 === "%%") return "%";
					index++;
					const formatter = createDebug$1.formatters[format$3];
					if (typeof formatter === "function") {
						const val = args[index];
						match$1 = formatter.call(self, val);
						args.splice(index, 1);
						index--;
					}
					return match$1;
...
//#endregion
//#region node_modules/.pnpm/@eslint+object-schema@3.0.0/node_modules/@eslint/object-schema/dist/esm/index.js
...
//#endregion
//#region node_modules/.pnpm/@eslint+config-array@0.23.0_patch_hash=9c56839266cb75a04e2a96a342456c69afd7549bf6c13a9ade49cc6d42de892a/node_modules/@eslint/config-array/dist/esm/index.js
/**
...
function doMatch(filepath, pattern, options = {}) {
	let cache$1 = minimatchCache;
	if (options.flipNegate) cache$1 = negatedMinimatchCache;
	let matcher = cache$1.get(pattern);
	if (!matcher) {
		matcher = new Minimatch(pattern, Object.assign({}, MINIMATCH_OPTIONS, options));
		cache$1.set(pattern, matcher);
	}
...
*/
function normalizeConfigPatterns(config, namespacedBasePath, path$4) {
	...
	if (hasBasePath) if (path$4.isAbsolute(config.basePath)) newConfig.basePath = path$4.toNamespacedPath(config.basePath);
	else newConfig.basePath = path$4.resolve(namespacedBasePath, config.basePath);
...
*/
async function normalize$1(items, context, extraConfigTypes, namespacedBasePath, path$4) {
	...
	const configs = [];
	for await (const config of asyncIterable) configs.push(normalizeConfigPatterns(config, namespacedBasePath, path$4));
	return configs;
}
/**
* Normalizes a `ConfigArray` by flattening it and executing any functions
...
* @throws {TypeError} When a config function returns a function.
*/
function normalizeSync(items, context, extraConfigTypes, namespacedBasePath, path$4) {
	const allowFunctions = extraConfigTypes.includes("function");
	const allowArrays = extraConfigTypes.includes("array");
	...
	const configs = [];
	for (const config of flatTraverse(items)) configs.push(normalizeConfigPatterns(config, namespacedBasePath, path$4));
	return configs;
}
/**
...
*/
function toRelativePath(fileOrDirPath, namespacedBasePath, path$4) {
	const fullPath = path$4.resolve(namespacedBasePath, fileOrDirPath);
	const namespacedFullPath = path$4.toNamespacedPath(fullPath);
	return path$4.relative(namespacedBasePath, namespacedFullPath).replaceAll(path$4.SEPARATOR, "/");
}
/**
...
*/
function shouldIgnorePath(configs, filePath, relativeFilePath, { basePath, path: path$4 } = {}) {
	let shouldIgnore = false;
	for (const config of configs) {
		let relativeFilePathToCheck = relativeFilePath;
		if (config.basePath) {
			relativeFilePathToCheck = toRelativePath(path$4.resolve(basePath, relativeFilePath), config.basePath, path$4);
...
function pathMatches(filePath, relativeFilePath, config) {
	...
	let filePathMatchesPattern = config.files.some((pattern) => {
		if (Array.isArray(pattern)) return pattern.every(match$1);
...
var ConfigArray = class extends Array {
	...
	*/
	get files() {
		...
		const cache$1 = dataCache.get(this);
		if (cache$1.files) return cache$1.files;
		const result = [];
		for (const config of this) if (config.files) config.files.forEach((filePattern) => {
			result.push(filePattern);
		});
		cache$1.files = result;
		dataCache.set(this, cache$1);
		return result;
	}
	/**
	...
	*/
	async normalize(context = {}) {
		if (!this.isNormalized()) {
			const normalizedConfigs = await normalize$1(this, context, this.extraConfigTypes, this.#namespacedBasePath, this.#path);
			this.length = 0;
	...
	*/
	getConfigWithStatus(filePath) {
		assertNormalized(this);
		const cache$1 = this[ConfigArraySymbol.configCache];
		if (cache$1.has(filePath)) return cache$1.get(filePath);
		...
		if (!matchFound) {
			...
			cache$1.set(filePath, CONFIG_WITH_STATUS_UNCONFIGURED);
			return CONFIG_WITH_STATUS_UNCONFIGURED;
		}
		const indicesKey = matchingConfigIndices.toString();
		let configWithStatus = cache$1.get(indicesKey);
		if (configWithStatus) {
			cache$1.set(filePath, configWithStatus);
		...
		cache$1.set(filePath, configWithStatus);
		cache$1.set(indicesKey, configWithStatus);
		return configWithStatus;
	}
	/**
	...
	*/
	isDirectoryIgnored(directoryPath) {
		...
		const cache$1 = dataCache.get(this).directoryMatches;
		if (cache$1.has(relativeDirectoryPath)) return cache$1.get(relativeDirectoryPath);
		...
		do {
			...
			cache$1.set(relativeDirectoryToCheck, result);
		} while (!result && directoryParts.length);
		cache$1.set(relativeDirectoryPath, result);
		return result;
	}
};
...
function minimatch(file, pattern) {
	let m$1 = _matchInstances.get(pattern);
	if (!m$1) {
		m$1 = new Minimatch(pattern, minimatchOpts);
		_matchInstances.set(pattern, m$1);
	}
	return m$1.match(file);
}
function getMatchedGlobs(file, glob$1) {
	return (Array.isArray(glob$1) ? glob$1 : [glob$1]).flat().filter((glob$2) => minimatch(file, glob$2)).flat();
}
...
var ConfigPathError = class extends ConfigInspectorError {
	constructor(basePath, configFilenames$1) {
		super("Cannot find ESLint config file");
		this.basePath = basePath;
		this.configFilenames = configFilenames$1;
...
var ConfigPathLegacyError = class extends ConfigInspectorError {
	constructor(basePath, configFilename) {
		...
		this.name = "ConfigPathLegacyError";
	}
	prettyPrint() {
		console.error(MARK_ERROR, this.message, c.dim(`
...
async function resolveConfigPath(options) {
	let { cwd: cwd$1, userConfigPath, userBasePath } = options;
	if (userBasePath) userBasePath = resolve(cwd$1, userBasePath);
	const lookupBasePath = userBasePath || cwd$1;
	let configPath = userConfigPath && resolve(cwd$1, userConfigPath);
	...
	if (!configPath) {
		...
		throw legacyConfigPath ? new ConfigPathLegacyError(`${relative(cwd$1, dirname(legacyConfigPath))}/`, basename(legacyConfigPath)) : new ConfigPathError(`${relative(cwd$1, lookupBasePath)}/`, configFilenames);
	}
	const basePath = normalize(userBasePath || (userConfigPath ? cwd$1 : dirname(configPath)));
...
async function readConfig(options) {
	...
	const eslintRules = await import(await resolve$1("eslint/use-at-your-own-risk", { url: basePath }).catch(() => null) || "eslint/use-at-your-own-risk").then((r$1) => r$1.default.builtinRules);
	...
	const configs = rawConfigs.map((c$1, idx) => {
		return {
			...c$1,
			index: idx,
			plugins: c$1.plugins ? Object.fromEntries(Object.entries(c$1.plugins ?? {}).map(([prefix]) => [prefix, {}]).filter((i$1) => i$1[0])) : void 0,
			languageOptions: c$1.languageOptions ? {
				...c$1.languageOptions,
				parser: c$1.languageOptions.parser?.meta?.name
			} : void 0,
			processor: c$1.processor?.meta?.name
		};
	});
...
async function createWsServer(options) {
	...
	watcher.on("change", (path$4) => {
		payload = void 0;
		console.log();
		console.log(MARK_CHECK, "Config change detected", path$4);
...
async function createHostServer(options) {
	...
	app.use("/", eventHandler(async (event) => {
		...
		}) === false) return readCachedFile(join(distDir, "index.html"));
	}));
...
cli.command("build", "Build inspector with current config file for static hosting").option("--config <configFile>", "Config file path").option("--files", "Include matched file paths in payload", { default: true }).option("--basePath <basePath>", "Base directory for globs to resolve. Default to directory of config file if not provided").option("--base <baseURL>", "Base URL for deployment", { default: "/" }).option("--outDir <dir>", "Output directory", { default: ".eslint-config-inspector" }).action(async (options) => {
	...
	const outDir = resolve(cwd$1, options.outDir);
	let configs;
	try {
	...
	if (baseURL !== "/") for (const file of htmlFiles) {
		const newContent = (await fs$1.readFile(resolve(distDir, file), "utf-8")).replaceAll(/\s(href|src)="\//g, ` $1="${baseURL}`).replaceAll("baseURL:\"/\"", `baseURL:"${baseURL}"`);
	...
	await fs$1.writeFile(resolve(outDir, "api/payload.json"), JSON.stringify(configs.payload, null, 2), "utf-8");
	console.log(MARK_CHECK, `Built to ${relative(cwd$1, outDir)}`);
	console.log(MARK_INFO, `You can use static server like \`npx serve ${relative(cwd$1, outDir)}\` to serve the inspector`);
});
cli.command("", "Start dev inspector").option("--config <configFile>", "Config file path").option("--files", "Include matched file paths in payload", { default: true }).option("--basePath <basePath>", "Base directory for globs to resolve. Default to directory of config file if not provided").option("--host <host>", "Host", { default: process$1.env.HOST || "127.0.0.1" }).option("--port <port>", "Port", { default: process$1.env.PORT || 7777 }).option("--open", "Open browser", { default: true }).action(async (options) => {
	...
	(await createHostServer({
		...
		if (options.open) await open_default(`http://${host === "127.0.0.1" ? "localhost" : host}:${port}`);
	});
});
cli.help();
cli.parse();
